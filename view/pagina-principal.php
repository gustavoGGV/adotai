  ...
  <body class="d-flex flex-column min-vh-100">
    ...
    <div class="flex-fill">
      ...
      <div class="container-lg d-flex flex-lg-row flex-column align-items-center">
        ...
        $numeroDeCards = 0;
        foreach ($pets as $pet):
            $dadosDoAcolhedor = $usuarioController->encontrarUsuarioPorId(
              ...
              <div class="card-pet card">
                ...
                <div class="corpo-card-pet p-4 card-body text-white">
                  ...
                  <div class="d-flex">
                    ...
                    <a href="<?= URL_BASE ?>/view/pagina-usuario.php/?idUsu=<?= $pet
    ->getAcolhedor()
    ->getIdUsu() ?>" class="text-white text-break"><?= $pet
    ->getAcolhedor()
    ->getNomeUsu() ?></a>
                  </div>
                </div>
