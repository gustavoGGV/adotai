...
if (isset($_POST["input-nome-pet"])) {
    $nomePet = trim($_POST["input-nome-pet"])
        ? trim($_POST["input-nome-pet"])
        : null;
    $sexoPet = trim($_POST["select-sexo-pet"])
        ? trim($_POST["select-sexo-pet"])
        : null;
    ...
    $idRaca = isset($_POST["select-raca-pet"])
        ? intval(trim($_POST["select-raca-pet"]))
        : null;
    $raca = new Raca($idRaca, null, null);

    $idEsp = trim($_POST["select-especie-pet"])
        ? trim($_POST["select-especie-pet"])
        : null;
    $especie = new Especie($idEsp, null, null);

    $idTem = trim($_POST["select-temperamento-pet"])
        ? trim($_POST["select-temperamento-pet"])
        : null;
    $temperamento = new Temperamento($idTem, null, null);

    $linkImagemPet = trim($_POST["input-imagem-pet"])
        ? trim($_POST["input-imagem-pet"])
        : null;
    $descricaoPet = trim($_POST["input-descricao-pet"])
        ? trim($_POST["input-descricao-pet"])
        : null;
