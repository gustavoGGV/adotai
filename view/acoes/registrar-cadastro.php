...
if (isset($_POST["input-numero"])) {
    ...
    $senhaUsu = trim($_POST["input-senha"])
        ? password_hash(trim($_POST["input-senha"]), PASSWORD_DEFAULT)
        : null;
    $confirmacaoSenhaUsu = trim($_POST["input-confirmar-senha"])
        ? password_verify(trim($_POST["input-confirmar-senha"]), $senhaUsu)
        : false;
